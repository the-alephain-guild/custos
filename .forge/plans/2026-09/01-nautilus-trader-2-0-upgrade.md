...
| 1b | ⏳ | | 触发判据已重写（见偏离日志）：本地造 wheel + `gh release create`，不经 CI。**三份中已得两份**，均出自 fork `3fe857a351`、版本 `2.0.0rc5+sodex.1`、maturin 1.15.0，两者的纯 Python 内容逐项一致：`macosx_11_0_arm64` sha256 `0a06c389f63e4c7d9825c2b68e8a225db2db6e92561bcf623eb6d81b2693af97`；`manylinux_2_39_aarch64` sha256 `d1e56ae74547712441eea7d3a46783655a59489a5c4f9dbd297db7b9f1aff754`（`make nautilus-wheel`，峰值 41.81 GiB / 36.7 分钟，需 VM ≥ 48 GB）。**缺 linux x86_64**：本机仅能 QEMU 模拟，且已知需 ≥ 42 GiB，标准托管 runner 的 16 GB 不够——待 larger runner / Depot / 一台 x86 机器 |
